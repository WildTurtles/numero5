...
CREATE TABLE IMMOVABLES (id SERIAL NOT NULL, description varchar(255), address varchar(255) NOT NULL, rental int4, rented bool NOT NULL, USER_id int4 NOT NULL, PRIMARY KEY (id));
