...
/**
 * TaxesCategories Model
 *
 * @property \Cake\ORM\Association\BelongsTo $Taxes
 * @property \Cake\ORM\Association\BelongsTo $Categories
 *
 * @method \App\Model\Entity\TaxCategories get($primaryKey, $options = [])
 * @method \App\Model\Entity\TaxCategories newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\TaxCategories[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\TaxCategories|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
